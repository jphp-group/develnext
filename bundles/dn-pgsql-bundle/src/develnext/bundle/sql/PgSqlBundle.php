...
use develnext\bundle\sql\components\PgSqlClientComponent;
...
class PgSqlBundle extends AbstractJarBundle
{
    ...
    public function onAdd(Project $project, AbstractBundle $owner = null)
    {
        ...
        if ($format) {
            $format->register(new PgSqlClientComponent());
        }
    }
    ...
    public function onRemove(Project $project, AbstractBundle $owner = null)
    {
        ...
        if ($format) {
            $format->unregister(new PgSqlClientComponent());
        }
    }
}