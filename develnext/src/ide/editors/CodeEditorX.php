 ...
 * @package ide\editors
 */
class CodeEditorX extends AbstractEditor
{
    ...
    public function __construct($file, $mode = 'css', $options = array())
    {
    ...
    public function executeCommand($command)
    {
        switch ($command) {
            ...
            case 'find': $this->showFindDialog(); break;
            case 'replace': $this->showReplaceDialog(); break;
